...
public class DynamicRequestPage extends CustomLayout {
    ...
    public DynamicRequestPage(BaseView view) {
    ...
    public void setError(List<TDEErrorType> errors) {
        ...
        for (TDEErrorType tdeErrorType : errors) {
            ...
            for (TextType errorText : tdeErrorType.getErrorText()) {
    ...
    public void setConceptErrors(String conceptErrors) {
