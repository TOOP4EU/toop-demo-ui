...
public class DynamicRequestPage extends CustomLayout {
  ...
  static {
    ...
    conceptList.add (new ConceptValue (sNS, "FreedoniaPostalCode"));
    conceptList.add (new ConceptValue (sNS, "FreedoniaRegion"));
    conceptList.add (new ConceptValue (sNS, "FreedoniaRegisteredOrganization"));
    conceptList.add (new ConceptValue (sNS, "FreedoniaTelephoneNumber"));
  }
